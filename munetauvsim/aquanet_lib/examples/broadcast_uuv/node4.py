...
def callback(msg):
	...
	call_goto(msg, goto4, interpolator)
...
def readauvpose(msg):
	global auv_heading
	auv_4heading = np.array([msg.twist.twist.linear.x, msg.twist.twist.linear.y])
...
if __name__=='__main__':
	...
	try:
		rospy.wait_for_service('rov4/go_to', timeout=15)
	except rospy.ROSException:
		raise rospy.ROSException('Service not available!')
	
	try:
		goto4 = rospy.ServiceProxy('rov4/go_to', GoTo)

...
def readauvpose(msg):
	global auv_heading
	auv_3heading = np.array([msg.twist.twist.linear.x, msg.twist.twist.linear.y])
...
if __name__=='__main__':
	...
	try:
		rospy.wait_for_service('rov3/go_to', timeout=15)
	except rospy.ROSException:
		raise rospy.ROSException('Service not available!')
	
	try:
		goto3 = rospy.ServiceProxy('rov3/go_to', GoTo)
